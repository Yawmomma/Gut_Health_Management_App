...
def filter_and_delete_orphaned_entries(all_entries):
    """Filter entries with content, auto-delete orphaned ones. Returns valid entries."""
    valid_entries = []
    deleted = False
...
def index():
    ...
    entries = filter_and_delete_orphaned_entries(all_entries)
